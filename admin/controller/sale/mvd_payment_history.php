  	...
  	public function index() {
   	...
   	private function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('sale/mvd_payment_history', 'token=' . $this->session->data['token'], true)
		);
		...
		$pagination->url = $this->url->link('sale/mvd_payment_history', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('sale/mvd_payment_history_list', $data));
  	}	
}
?>