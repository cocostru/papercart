	...
	public function delete() {
   	...
   	private function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('sale/contstatctrl', 'token=' . $this->session->data['token'], true)
		);
		
		$data['sendEmail'] = $this->url->link('sale/contstatctrl/sendNotification', 'token=' . $this->session->data['token'] . $url, true);
		$data['update'] = $this->url->link('sale/contstatctrl/update', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('sale/contstatctrl/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		$pagination->url = $this->url->link('sale/contstatctrl', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('sale/contstatctrl_list', $data));
  	}
