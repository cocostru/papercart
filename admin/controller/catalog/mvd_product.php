...
class ControllerCatalogMVDProduct extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('catalog/mvd_product/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['copy'] = $this->url->link('catalog/mvd_product/copy', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/mvd_product/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			...
			$data['products'][] = array(
				...
				'edit'       => $this->url->link('catalog/mvd_product/edit', 'token=' . $this->session->data['token'] . '&product_id=' . $result['product_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'] . '&sort=pd.name' . $url, true);
		$data['sort_model'] = $this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'] . '&sort=p.model' . $url, true);
		$data['sort_price'] = $this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'] . '&sort=p.price' . $url, true);
		$data['sort_quantity'] = $this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'] . '&sort=p.quantity' . $url, true);
		$data['sort_status'] = $this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'] . '&sort=p.status' . $url, true);
		$data['sort_order'] = $this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'] . '&sort=p.sort_order' . $url, true);
		//mvds
		$data['sort_sku'] = $this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'] . '&sort=p.sku' . $url, true);
		$data['sort_vendor_name'] = $this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'] . '&sort=vds.vendor_id' . $url, true);
		//mvde
		...
		$pagination->url = $this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('catalog/mvd_product_list', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['product_id'])) {
			$data['action'] = $this->url->link('catalog/mvd_product/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/mvd_product/edit', 'token=' . $this->session->data['token'] . '&product_id=' . $this->request->get['product_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'] . $url, true);
		...
		$this->response->setOutput($this->load->view('catalog/mvd_product_form', $data));
	}
