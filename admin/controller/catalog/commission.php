	...
	private $error = array();
  	...
  	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/commission', 'token=' . $this->session->data['token'] . $url, true));
    	}
  	...
  	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/commission', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['insert'] = $this->url->link('catalog/commission/insert', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/commission/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			...
			$data['commissions'][] = array(
				...
				'edit'     			=> $this->url->link('catalog/commission/update', 'token=' . $this->session->data['token'] . '&commission_id=' . $result['commission_id'] . $url, true)
			);
    	}
		...
		$data['sort_commission_name'] = $this->url->link('catalog/commission&token=' . $this->session->data['token'] . '&sort=commission_name' . $url, true);
		$data['sort_commission_type'] = $this->url->link('catalog/commission&token=' . $this->session->data['token'] . '&sort=commission_type' . $url, true);
		$data['sort_commission'] = $this->url->link('catalog/commission&token=' . $this->session->data['token'] . '&sort=commission' . $url, true);
		$data['sort_sort_order'] = $this->url->link('catalog/commission&token=' . $this->session->data['token'] . '&sort=sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('catalog/commission', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
  	...
  	private function getForm() {
		...
		if (!isset($this->request->get['commission_id'])) {
			$data['action'] = $this->url->link('catalog/commission/insert', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/commission/update', 'token=' . $this->session->data['token'] . '&commission_id=' . $this->request->get['commission_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/commission', 'token=' . $this->session->data['token'] . $url, true);
