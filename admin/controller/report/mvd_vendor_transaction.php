...
class ControllerReportMVDVendorTransaction extends Controller { 
	public function index() {  
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/mvd_vendor_transaction', 'token=' . $this->session->data['token'] . $url, true)
		);
		...
		$data['addPayment'] = $this->url->link('report/mvd_vendor_transaction/insert', 'token=' . $this->session->data['token'] . $url, true);
		
		$pagination = new Pagination();
		$pagination->total = $order_total;
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('report/mvd_vendor_transaction', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('report/mvd_vendor_transaction', $data));
	}
	...
	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			...
			$this->response->redirect($this->url->link('report/mvd_vendor_transaction', 'token=' . $this->session->data['token'] . $url, true));
    	}
	...
	public function addPaymentRecord() {
		...
		$this->response->redirect($this->url->link('report/mvd_vendor_transaction', 'token=' . $this->session->data['token'], true));
