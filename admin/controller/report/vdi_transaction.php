...
class ControllerReportVDITransaction extends Controller { 
	public function index() {  
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/vdi_transaction', 'token=' . $this->session->data['token'] . $url, true)
		);
		...
		$data['addPayment'] = $this->url->link('report/vdi_transaction/insert', 'token=' . $this->session->data['token'] . $url, true);
		
		$pagination = new Pagination();
		$pagination->total = $order_total;
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('report/vdi_transaction', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('report/vdi_transaction', $data));
	}
}
?>