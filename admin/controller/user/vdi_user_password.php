...
class ControllerUserVDIUserPassword extends Controller {  
	...
	public function update() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('user/vdi_user_password', 'token=' . $this->session->data['token'], true));
    	}
	...
	protected function getForm() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('user/vdi_user_password', 'token=' . $this->session->data['token'], true)
		);
		
		$data['action'] = $this->url->link('user/vdi_user_password/update', 'token=' . $this->session->data['token'], true);
		
    	$data['cancel'] = $this->url->link('common/vdi_dashboard', 'token=' . $this->session->data['token'], true);
		...
		$this->response->setOutput($this->load->view('user/vdi_user_password', $data));
	}
