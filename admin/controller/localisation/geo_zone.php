...
class ControllerLocalisationGeoZone extends Controller {
	...
	protected function getForm() {
		...
		// $data['countries'] = $this->model_localisation_country->getCountries(); //to vQmod

		$data['countries'] = array(); //to vQmod

		$fcountries = $this->model_localisation_country->getCountries(); //to vQmod

		foreach ($fcountries as $result) { //to vQmod
			if ($result['country_id'] > 257) //to vQmod
			$data['countries'][] = $result; //to vQmod
		} //to vQmod
