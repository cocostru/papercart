      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <td><div class="btn"  data-toggle="tooltip" data-original-title="All Settings" onclick="$('table[id*=option-value] td:nth-of-type(4), table[id*=option-value] td:nth-of-type(5), table[id*=option-value] td:nth-of-type(6)').toggleClass('m');$(this).find('i').toggleClass('fa-chevron-left').toggleClass('fa-chevron-right')"><i class="fa fa-chevron-left"></i></div></td>
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
            ...
            html += '<td><div class="btn"  data-toggle="tooltip" data-original-title="All Settings" onclick="$(\'table[id*=option-value] td:nth-of-type(4), table[id*=option-value] td:nth-of-type(5), table[id*=option-value] td:nth-of-type(6)\').toggleClass(\'m\');$(this).find(\'i\').toggleClass(\'fa-chevron-left\').toggleClass(\'fa-chevron-right\')"><i class="fa fa-chevron-left"></i></div></td>';
...
//--></script></div>
            ...
            <style> select[name*=price_prefix], select[name*=points_prefix], select[name*=weight_prefix] { float: left; display: inline-block; width: 40% } input[name*=price], input[name*=points], input[name*=weight] { display: inline-block; width: 50% } table[id*=option-value] thead td { font-weight: normal; text-align: center } table[id*=option-value] .form-control { height: 30px; padding: 5px } table[id*=option-value] td:nth-of-type(4), table[id*=option-value] td:nth-of-type(5), table[id*=option-value] td:nth-of-type(6) { display: none } table[id*=option-value] td.m { display: table-cell } table[id*=option-value], table[id*=option-value] tfoot td { border: none } table[id*=option-value] thead td { border-bottom-width: 1px; border-top: 1px solid #ddd !important } table[id*=option-value] tr td:last-of-type { text-align: center; width: 5% } </style>
