            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $product['price_to_vendor']; ?> <?php if($yet): ?><a><i class="fa fa-exclamation-circle" data-toggle="tooltip" data-original-title="Price will be updated after approval."></i></a><?php endif; ?></td>
