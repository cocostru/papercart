...
class ControllerCatalogCategory extends Controller {
	...
	protected function getList() {
		...
		$results = $this->model_catalog_category->getCategories($filter_data);
			...
			$exists_alt = $this->db->query("SHOW COLUMNS FROM `" . DB_PREFIX . "category` LIKE 'threshold'");
			if (!$exists_alt->rows) $this->db->query("ALTER TABLE `" . DB_PREFIX . "category` ADD `threshold` INT(11) NOT NULL default '0'");
