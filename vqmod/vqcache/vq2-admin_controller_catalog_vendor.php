...
class ControllerCatalogVendor extends Controller {
	private $error = array();
  	...
  	private function getList() {
		...
		$data['add'] = $this->url->link('catalog/vendor/insert', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			...
			$data['vendors'][] = array(
				...
				'view'				=> $this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'] . '&filter_vendor=' . $result['vendor_id'] . $url, true),
				'edit'     			=> $this->url->link('catalog/vendor/update', 'token=' . $this->session->data['token'] . '&vendor_id=' . $result['vendor_id'] . $url, true)
			);
    	}
		...
		$data['sort_vendor_name'] = $this->url->link('catalog/vendor', 'token=' . $this->session->data['token'] . '&sort=vendor_name' . $url, true);
		$data['sort_commission'] = $this->url->link('catalog/vendor', 'token=' . $this->session->data['token'] . '&sort=commission' . $url, true);
		$data['sort_status'] = $this->url->link('catalog/vendor', 'token=' . $this->session->data['token'] . '&sort=status' . $url, true);
  	...
  	private function getForm() {
		...
		if (!isset($this->request->get['vendor_id'])) {
			$data['action'] = $this->url->link('catalog/vendor/insert', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/vendor/update', 'token=' . $this->session->data['token'] . '&vendor_id=' . $this->request->get['vendor_id'] . $url, true);
		}
