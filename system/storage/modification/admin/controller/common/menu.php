...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['openbay_markets'] = array(
            ...
            $data['mvd_add_vendors'] = $this->url->link('catalog/vendor', 'token=' . $this->session->data['token'], true);
			$data['mvd_add_courier'] = $this->url->link('catalog/courier', 'token=' . $this->session->data['token'], true);
			$data['mvd_product'] = $this->url->link('catalog/mvd_product', 'token=' . $this->session->data['token'], true);
			$data['mvd_download'] = $this->url->link('catalog/mvd_download', 'token=' . $this->session->data['token'], true);
			$data['mvd_option'] = $this->url->link('catalog/mvd_option', 'token=' . $this->session->data['token'], true);
			$data['mvd_category'] = $this->url->link('catalog/mvd_category', 'token=' . $this->session->data['token'], true);
			$data['mvd_information'] = $this->url->link('catalog/mvd_information', 'token=' . $this->session->data['token'], true);
			$data['mvd_attribute'] = $this->url->link('catalog/mvd_attribute', 'token=' . $this->session->data['token'], true);
			$data['mvd_attribute_group'] = $this->url->link('catalog/mvd_attribute_group', 'token=' . $this->session->data['token'], true);
			$data['mvd_prostatctrl'] = $this->url->link('catalog/prostatctrl', 'token=' . $this->session->data['token'], true);
			$data['mvd_setting'] = $this->url->link('catalog/vendor_setting', 'token=' . $this->session->data['token'], true);
			$data['mvd_commission'] = $this->url->link('catalog/commission', 'token=' . $this->session->data['token'], true);
			$data['mvd_limit'] = $this->url->link('catalog/prolimit', 'token=' . $this->session->data['token'], true);
			$data['mvd_contstatctrl'] = $this->url->link('sale/contstatctrl', 'token=' . $this->session->data['token'], true);
			$data['mvd_ven_transaction'] = $this->url->link('report/mvd_vendor_transaction', 'token=' . $this->session->data['token'], true);
			$data['mvd_payment_history'] = $this->url->link('sale/mvd_payment_history', 'token=' . $this->session->data['token'], true);
			$data['mvd_contract_history'] = $this->url->link('sale/mvd_contract_history', 'token=' . $this->session->data['token'], true);
			$data['mvd_ven_report'] = $this->url->link('report/vendor_sale_order', 'token=' . $this->session->data['token'], true);
			$data['mvd_coupon'] = $this->url->link('marketing/mvd_coupon', 'token=' . $this->session->data['token'], true);
            
		return $this->load->view('common/menu', $data);

            } else {
				$data['home'] = $this->url->link('common/vdi_dashboard', 'token=' . $this->session->data['token'], true);
				$data['vdi_product'] = $this->url->link('catalog/vdi_product', 'token=' . $this->session->data['token'], true);
				$data['vdi_category'] = $this->url->link('catalog/vdi_category', 'token=' . $this->session->data['token'], true);
				$data['vdi_option'] = $this->url->link('catalog/vdi_option', 'token=' . $this->session->data['token'], true);
				$data['vdi_attribute'] = $this->url->link('catalog/vdi_attribute', 'token=' . $this->session->data['token'], true);
				$data['vdi_attribute_group'] = $this->url->link('catalog/vdi_attribute_group', 'token=' . $this->session->data['token'], true);
				$data['vdi_information'] = $this->url->link('catalog/vdi_information', 'token=' . $this->session->data['token'], true);
				$data['vdi_download'] = $this->url->link('catalog/vdi_download', 'token=' . $this->session->data['token'], true);
				$data['vdi_report_product_viewed'] = $this->url->link('report/vdi_product_viewed', 'token=' . $this->session->data['token'], true);
				$data['vdi_report_product_purchased'] = $this->url->link('report/vdi_product_purchased', 'token=' . $this->session->data['token'], true);
				$data['vdi_contract_history'] = $this->url->link('sale/vdi_contract_history', 'token=' . $this->session->data['token'], true);
				$data['vdi_update_vendor_profile'] = $this->url->link('catalog/vdi_vendor_profile', 'token=' . $this->session->data['token'], true);
				$data['vdi_user_password'] = $this->url->link('user/vdi_user_password', 'token=' . $this->session->data['token'], true);
				$data['vdi_sale_order'] = $this->url->link('sale/vdi_order', 'token=' . $this->session->data['token'], true);
				$data['vdi_coupon'] = $this->url->link('marketing/vdi_coupon', 'token=' . $this->session->data['token'], true);
				$data['vdi_transaction'] = $this->url->link('report/vdi_transaction', 'token=' . $this->session->data['token'], true);
				...
				return $this->load->view('common/vdi_menu', $data);
			}
