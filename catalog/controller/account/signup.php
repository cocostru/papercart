...
class ControllerAccountSignUp extends Controller {
	private $error = array();
  	...
  	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('account/signup', '', true),
    	...
    	$data['action'] = $this->url->link('account/signup', '', true);
		...
		if ($this->config->get('mvd_signup_policy')) {
			...
			if ($information_info) {
				$data['text_agree'] = sprintf($this->language->get('text_agree'), $this->url->link('information/information/agree', 'information_id=' . $this->config->get('mvd_signup_policy'), true), $information_info['title'], $information_info['title']);
			} else {
				$data['text_agree'] = '';
			}
		} else {
		...
		$this->response->setOutput($this->load->view('account/signup', $data));
	...
	public function send() {
		...
		$request .= '&notify_url=' . $this->url->link('account/signup_callback/signup_callback', '', true);
		$request .= '&cancel_return=' . $this->url->link('account/signup', '', true);
